            ...
            <div className="container mx-auto px-6 text-center">
                <div className="max-w-4xl mx-auto">
                    ...
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 tracking-tight leading-[1.1]">
                        <span className="bg-[#00ef99] px-2">{highlightWords}</span> {restOfTitle}
                    </h1>
            ...
            <div className="container mx-auto px-6">
                <div className="max-w-4xl mx-auto">
                    ...
                    <div className="mt-16 p-8 bg-black text-white rounded-2xl text-center">
                        ...
                        <Link
                            href="https://app.growlocal360.com/login"
                            className="inline-flex items-center justify-center gap-2 bg-[#00ef99] hover:bg-[#00d584] text-black px-8 py-4 rounded-full font-bold text-lg transition-all"
                        >
                            Create Free Account
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <line x1="5" y1="12" x2="19" y2="12"></line>
